...
data:extend({  

  {
    ...
    icon = "__leighzerslowncheapitems__/graphics/icons/chemical-plant.png",
  ...
  
  {
    ...
    {
      {
        filename = "__leighzerslowncheapitems__/graphics/entity/chemical-plant/chemical-plant.png",
        width = 108,
        height = 148,
        frame_count = 24,
        line_length = 12,
        ...
        hr_version =
        {
          filename = "__leighzerslowncheapitems__/graphics/entity/chemical-plant/hr-chemical-plant.png",
          width = 220,
          height = 292,
          frame_count = 24,
          line_length = 12,
