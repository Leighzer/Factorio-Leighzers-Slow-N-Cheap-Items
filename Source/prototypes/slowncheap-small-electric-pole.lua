...
data:extend({
  
  {
    ...
    icon = "__leighzerslowncheapitems__/graphics/icons/small-electric-pole.png",
...

  {
    ...
    pictures =
    {
      ...
      {
        {
          filename = "__leighzerslowncheapitems__/graphics/entity/small-electric-pole/small-electric-pole.png",
          priority = "extra-high",
          width = 36,
          height = 108,
          direction_count = 4,
          ...
          hr_version =
          {
            filename = "__leighzerslowncheapitems__/graphics/entity/small-electric-pole/hr-small-electric-pole.png",
            priority = "extra-high",
            width = 72,
            height = 220,
            direction_count = 4,
