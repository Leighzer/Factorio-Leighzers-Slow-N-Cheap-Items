if leighzermods.leighzerslowncheapitems.slowncheapBurnerMiningDrillEnabled then
  ...
  data:extend({
      {
          ...
          order = "a",
          place_result = "slowncheap-burner-mining-drill",
          stack_size = 50
        },
        ...
        },
      {
          ...
          next_upgrade = "burner-mining-drill",
